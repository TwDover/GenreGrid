...
.text-input:focus { border-color: #00c8ff55; }
...
.num-input:focus { border-color: #00c8ff55; }
...
.reset-btn:hover { background: #122f40; color: #e0e0e8; }
...
.save-btn:hover:not(:disabled) { background: #004d7a; color: #7ae8ff; }
